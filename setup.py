...
setup(
    ...
    packages=['eden', 'eden.lib.eden', 
                'eden.lib.eden.util', 'eden.lib.eden.graphicalizer',
                'eden.lib.eden.graphicalizer.graph',
                'eden.lib.eden.graphicalizer.molecule',
                'eden.lib.eden.graphicalizer.RNA',
                'eden.test'],
    scripts=['eden/bin/alignment', 'eden/bin/annotate', 'eden/bin/cluster_kmeans',
             'eden/bin/cluster_DBSCAN', 'eden/bin/convert', 'eden/bin/dendrogram',
             'eden/bin/fit', 'eden/bin/features', 'eden/bin/matrix',
             'eden/bin/nearest_neighbor', 'eden/bin/max_subarrays', 'eden/bin/predict',
            ],
